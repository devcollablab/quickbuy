...
const [editingId, setEditingId] = useState(null);
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await customAxios.delete(urlDeleteProduct(id));
      ...
      <div className="flex-1 p-4 md:p-6">
        ...
        <div className="mb-6">
          <div className="flex items-center justify-between gap-4 mb-4">
            ...
            <h1 className="text-2xl md:text-3xl font-bold text-gray-900">Admin Page</h1>

            {/* Add button */}
            <button 
            onClick={() => setShowModal(true)}
            className="bg-black text-white font-semibold px-6 py-3 rounded shadow">Add Product</button>
          </div>
    ...
    <div className="p-2 md:p-4">
      ...
      <div className="flex gap-2">
        <button
          ...
          className="flex-1 text-xs md:text-sm bg-blue-600 text-white py-1.5 rounded hover:bg-blue-700"
        >
          Update
        </button>
        ...
        <button
          ...
          className="flex-1 text-xs md:text-sm bg-red-600 text-white py-1.5 rounded hover:bg-red-700"
        >
          Delete
        </button>
      </div>
